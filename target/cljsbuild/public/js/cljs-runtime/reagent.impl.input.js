...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__76811){
var map__76812 = p__76811;
var map__76812__$1 = (((((!((map__76812 == null))))?(((((map__76812.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76812.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76812):map__76812);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76812__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(jsprops.onChange = (function (p1__76820_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__76820_SHARP_);
}));
