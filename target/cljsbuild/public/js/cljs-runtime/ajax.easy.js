...
var G__78070 = format;
var G__78070__$1 = (((G__78070 instanceof cljs.core.Keyword))?G__78070.fqn:null);
switch (G__78070__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__78071 = cljs.core.second(format);
var G__78072 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__78071,G__78072) : ajax.easy.keyword_response_format_element.call(null,G__78071,G__78072));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__78073 = format;
var G__78073__$1 = (((G__78073 instanceof cljs.core.Keyword))?G__78073.fqn:null);
switch (G__78073__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__78080_SHARP_){
return ajax.easy.keyword_response_format_element(p1__78080_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__78083){
var map__78084 = p__78083;
var map__78084__$1 = (((((!((map__78084 == null))))?(((((map__78084.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78084.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__78084):map__78084);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78084__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78084__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78084__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__78086){
var vec__78087 = p__78086;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78087,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78087,(1),null);
var fexpr__78090_78117 = (cljs.core.truth_(ok)?h:e);
(fexpr__78090_78117.cljs$core$IFn$_invoke$arity$1 ? fexpr__78090_78117.cljs$core$IFn$_invoke$arity$1(result) : fexpr__78090_78117.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__78092){
var map__78093 = p__78092;
var map__78093__$1 = (((((!((map__78093 == null))))?(((((map__78093.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78093.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__78093):map__78093);
var opts = map__78093__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78093__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78093__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78093__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78093__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78093__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
