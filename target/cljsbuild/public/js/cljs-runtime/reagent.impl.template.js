...
var G__76832 = o;
goog.object.set(G__76832,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__76852__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__76852 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__76853__i = 0, G__76853__a = new Array(arguments.length -  0);
while (G__76853__i < G__76853__a.length) {G__76853__a[G__76853__i] = arguments[G__76853__i + 0]; ++G__76853__i;}
  args = new cljs.core.IndexedSeq(G__76853__a,0,null);
} 
return G__76852__delegate.call(this,args);};
G__76852.cljs$lang$maxFixedArity = 0;
G__76852.cljs$lang$applyTo = (function (arglist__76854){
var args = cljs.core.seq(arglist__76854);
return G__76852__delegate(args);
});
G__76852.cljs$core$IFn$_invoke$arity$variadic = G__76852__delegate;
return G__76852;
})()
;
} else {
...
var G__76833 = o;
goog.object.set(G__76833,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
while (G__76860__i < G__76860__a.length) {G__76860__a[G__76860__i] = arguments[G__76860__i + 0]; ++G__76860__i;}
  args = new cljs.core.IndexedSeq(G__76860__a,0,null);
} 
...
var G__76834 = props;
var G__76834__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__76834,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__76834);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__76834__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__76835 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__76835,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__76835;
}
})(),id_class);
...
var G__76836 = (cljs.core.count(argv) - first_child);
switch (G__76836) {
case (0):
...
var vec__76837 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76837,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76837,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76837,(2),null);
...
var temp__5739__auto___76870 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___76870 == null)){
} else {
var key_76873 = temp__5739__auto___76870;
(jsprops.key = key_76873);
}
...
var temp__5739__auto___76874 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___76874 == null)){
} else {
var key_76875 = temp__5739__auto___76874;
(jsprops.key = key_76875);
}
...
var temp__5739__auto___76876 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___76876 == null)){
} else {
var key_76877 = temp__5739__auto___76876;
(jsprops.key = key_76877);
}
...
var temp__5739__auto___76884 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___76884 == null)){
} else {
var key_76885 = temp__5739__auto___76884;
(jsprops.key = key_76885);
}
...
var temp__5739__auto___76886 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___76886 == null)){
} else {
var key_76887 = temp__5739__auto___76886;
(jsprops.key = key_76887);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__76840_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__76840_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__76841 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76841,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76841,(1),null);
...
break;
default:
var G__76889 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__76890 = compiler;
v = G__76889;
compiler = G__76890;
continue;
...
var G__76845 = tag;
var G__76845__$1 = (((G__76845 instanceof cljs.core.Keyword))?G__76845.fqn:null);
switch (G__76845__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template76847 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template76847 = (function (opts,id,fn_to_element,meta76848){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.meta76848 = meta76848;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template76847.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_76849,meta76848__$1){
var self__ = this;
var _76849__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template76847(self__.opts,self__.id,self__.fn_to_element,meta76848__$1));
}));

(reagent.impl.template.t_reagent$impl$template76847.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_76849){
var self__ = this;
var _76849__$1 = this;
return self__.meta76848;
}));

(reagent.impl.template.t_reagent$impl$template76847.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template76847.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template76847.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template76847.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template76847.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta76848","meta76848",1790571854,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template76847.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template76847.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template76847");

(reagent.impl.template.t_reagent$impl$template76847.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template76847");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template76847.
 */
reagent.impl.template.__GT_t_reagent$impl$template76847 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template76847(opts__$1,id__$1,fn_to_element__$1,meta76848){
return (new reagent.impl.template.t_reagent$impl$template76847(opts__$1,id__$1,fn_to_element__$1,meta76848));
});

}

return (new reagent.impl.template.t_reagent$impl$template76847(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
