...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__78027){
var map__78028 = p__78027;
var map__78028__$1 = (((((!((map__78028 == null))))?(((((map__78028.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78028.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__78028):map__78028);
var request = map__78028__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78028__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__78032 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__78032.cljs$core$IFn$_invoke$arity$1 ? fexpr__78032.cljs$core$IFn$_invoke$arity$1(response) : fexpr__78032.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__78033 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__78033.cljs$core$IFn$_invoke$arity$1 ? fexpr__78033.cljs$core$IFn$_invoke$arity$1(response) : fexpr__78033.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__78034){
...
var request = map__78035__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78035__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
