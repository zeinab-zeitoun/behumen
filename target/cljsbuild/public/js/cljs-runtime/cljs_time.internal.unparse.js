...
var periods__$1 = cljs.core.vec((function (){var G__79325 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__79324_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__79324_SHARP_,(0),(3));
}),G__79325);
} else {
return G__79325;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__79355){
var vec__79356 = p__79355;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79356,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79356,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__79364 = pattern;
switch (G__79364) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__79364)].join('')));
...
var G__79375 = key;
var G__79375__$1 = (((G__79375 instanceof cljs.core.Keyword))?G__79375.fqn:null);
switch (G__79375__$1) {
case "millis":
return (function (p1__79367_SHARP_){
return p1__79367_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__79368_SHARP_){
return p1__79368_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__79369_SHARP_){
return p1__79369_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__79370_SHARP_){
return p1__79370_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__79371_SHARP_){
return p1__79371_SHARP_.getHours();
});

break;
case "day":
return (function (p1__79372_SHARP_){
return p1__79372_SHARP_.getDate();
});

break;
case "month":
return (function (p1__79373_SHARP_){
return p1__79373_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__79374_SHARP_){
return p1__79374_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__79375__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__79382){
var vec__79383 = p__79382;
var seq__79384 = cljs.core.seq(vec__79383);
var first__79385 = cljs.core.first(seq__79384);
var seq__79384__$1 = cljs.core.next(seq__79384);
var key = first__79385;
var args = seq__79384__$1;
var G__79386 = key;
...
break;
case "ordinal-suffix":
var vec__79387 = (function (){var G__79390 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__79390) : syntax_list.call(null,G__79390));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79387,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__79386__$1)].join('')));
...
var d = value;
var G__79394 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__79395 = G__79394;
var seq__79396 = cljs.core.seq(vec__79395);
var first__79397 = cljs.core.first(seq__79396);
var seq__79396__$1 = cljs.core.next(seq__79396);
var unparser = first__79397;
var more = seq__79396__$1;
var s = "";
var d__$1 = d;
var G__79394__$1 = G__79394;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__79406 = G__79394__$1;
var seq__79407 = cljs.core.seq(vec__79406);
var first__79408 = cljs.core.first(seq__79407);
var seq__79407__$1 = cljs.core.next(seq__79407);
var unparser__$1 = first__79408;
var more__$1 = seq__79407__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__79409 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79409,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79409,(1),null);
var G__79445 = d__$3;
var G__79446 = more__$1;
var G__79447 = s__$3;
d__$1 = G__79445;
G__79394__$1 = G__79446;
s__$1 = G__79447;
continue;
}
break;
