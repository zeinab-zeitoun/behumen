...
var G__68169 = devtools.prefs.pref(v);
v = G__68169;
continue;
} else {
return v;
...
}catch (e68106){var _e__65701__auto__ = e68106;
return false;
}})();
...
}catch (e68110){var _e__65701__auto__ = e68110;
return false;
}})();
...
}catch (e68112){var _e__65701__auto__ = e68112;
return false;
}}
}
});
...
var vec__68135 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68135,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68135,(1),null);
...
return cljs.core.some((function (p1__68142_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__68142_SHARP_);
}),template);
});
