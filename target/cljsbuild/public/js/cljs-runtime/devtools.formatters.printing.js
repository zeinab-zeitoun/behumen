...
var len__4736__auto___68572 = arguments.length;
var i__4737__auto___68573 = (0);
while(true){
if((i__4737__auto___68573 < len__4736__auto___68572)){
args__4742__auto__.push((arguments[i__4737__auto___68573]));

var G__68574 = (i__4737__auto___68573 + (1));
i__4737__auto___68573 = G__68574;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq68375){
var G__68376 = cljs.core.first(seq68375);
var seq68375__$1 = cljs.core.next(seq68375);
var G__68377 = cljs.core.first(seq68375__$1);
var seq68375__$2 = cljs.core.next(seq68375__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__68376,G__68377,seq68375__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__68455_SHARP_){
return (!((cljs.core.meta(p1__68455_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68495__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e68530){var _e__65701__auto__ = e68530;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e68532){var _e__65701__auto__ = e68532;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__68534 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__68535 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__68535);

try{var map__68536 = opts;
var map__68536__$1 = (((((!((map__68536 == null))))?(((((map__68536.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68536.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68536):map__68536);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68536__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__68534);
}});
...
var temp__5733__auto___68617 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___68617)){
var managed_print_level_68618 = temp__5733__auto___68617;
var _STAR_print_level_STAR__orig_val__68558_68619 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__68560_68620 = managed_print_level_68618;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__68560_68620);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__68538_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__68538_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__68558_68619);
}} else {
job_fn();
}
