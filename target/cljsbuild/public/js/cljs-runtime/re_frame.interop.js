...
return [(function (){var pred__76974 = cljs.core.instance_QMARK_;
var expr__76975 = reactive_val;
if(cljs.core.truth_((pred__76974.cljs$core$IFn$_invoke$arity$2 ? pred__76974.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__76975) : pred__76974.call(null,reagent.ratom.RAtom,expr__76975)))){
return "ra";
} else {
if(cljs.core.truth_((pred__76974.cljs$core$IFn$_invoke$arity$2 ? pred__76974.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__76975) : pred__76974.call(null,reagent.ratom.RCursor,expr__76975)))){
return "rc";
} else {
if(cljs.core.truth_((pred__76974.cljs$core$IFn$_invoke$arity$2 ? pred__76974.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__76975) : pred__76974.call(null,reagent.ratom.Reaction,expr__76975)))){
return "rx";
} else {
if(cljs.core.truth_((pred__76974.cljs$core$IFn$_invoke$arity$2 ? pred__76974.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__76975) : pred__76974.call(null,reagent.ratom.Track,expr__76975)))){
return "tr";
} else {
return "other";
}
