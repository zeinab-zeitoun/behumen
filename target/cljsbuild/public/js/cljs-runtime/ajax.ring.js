...
(ajax.ring.ring_response_format.cljs$core$IFn$_invoke$arity$1 = (function (p__78041){
var map__78042 = p__78041;
var map__78042__$1 = (((((!((map__78042 == null))))?(((((map__78042.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78042.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__78042):map__78042);
var map__78043 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78042__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var map__78043__$1 = (((((!((map__78043 == null))))?(((((map__78043.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78043.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__78043):map__78043);
var read = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78043__$1,new cljs.core.Keyword(null,"read","read",1140058661));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78043__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var content_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78043__$1,new cljs.core.Keyword(null,"content-type","content-type",-508222634));
